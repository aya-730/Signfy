...
class TranslateTextToSignPage extends StatefulWidget {
  @override
  _TranslateTextToSignPageState createState() =>
      _TranslateTextToSignPageState();
}

class _TranslateTextToSignPageState extends State<TranslateTextToSignPage> {
  ...
  void _translateText(BuildContext context) async {
    ...
    final response = await http.post(
      Uri.parse(
          'http://192.168.153.51:8000/translation/translate_text_to_sign/'), // Ensure this matches your Django URL
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Translate Text to Sign'),
        actions:[
          IconButton(
            icon: Text(
              '☰',
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  errorText:
                  showTextError ? 'Please enter text to translate' : null,
